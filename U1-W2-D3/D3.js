...
for (i = 0; i < starWarsCharacters.length; i++) {
  ...
  console.log(charactersNames); // se però stampo fuori dal blocco, mi da solo il primo nome!
}
...
//OPPURE//
// for (i = 0; i < starWarsCharacters.length; i++) {
// femalecharacters = starWarsCharacters[i].gender.female;
//femalecharacters.push(gender.female);
//}console.log(femaleCharacters);
...
let count = 0;
while (count < 10) {
  let increment = starWarsCharacters[lenght].mass;
